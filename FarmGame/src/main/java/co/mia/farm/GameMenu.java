...
public class GameMenu {
	...
	private void game() {
		...
		if (ConsolePrintService.userY == 0 && ConsolePrintService.userX == 1) { // 내 위치가 상점
			...
			System.out.printf("\n%d별 입니다! 주머니에 넣을게요!", SecretMoneyService.smMoney);
			...
			if (ConsolePrintService.userX == ConsolePrintService.monsterX
					&& ConsolePrintService.userY == ConsolePrintService.monsterY) {
